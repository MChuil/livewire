                        ...
                        <li class="list dropdown-item">
                            ...
                            <ul class="dropdown-menu-list list-unstyled ps-scrollbar">
                                <li class="unread status-available">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{ asset('data/profile/avatar-1.png') }}" alt="user-image" class="rounded-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                ...
                                <li class=" status-away">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{ asset('data/profile/avatar-2.png') }}" alt="user-image" class="rounded-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                ...
                                <li class=" status-busy">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{ asset('data/profile/avatar-3.png') }}" alt="user-image" class="rounded-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                ...
                                <li class=" status-offline">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{ asset('data/profile/avatar-4.png') }}" alt="user-image" class="rounded-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
                                ...
                                <li class=" status-offline">
                                    <a href="javascript:;">
                                        <div class="user-img">
                                            <img src="{{ asset('data/profile/avatar-5.png') }}" alt="user-image" class="rounded-circle img-inline">
                                        </div>
                                        <div>
                                            <span class="name">
        ...
        <div class='float-right'>
            <ul class="info-menu right-links list-inline list-unstyled">
                <li class="profile list-inline-item">
                    <a href="#" data-toggle="dropdown" class="toggle">
                        <img src="{{ asset('data/profile/profile.png') }}" alt="user-image" class="rounded-circle img-inline">
